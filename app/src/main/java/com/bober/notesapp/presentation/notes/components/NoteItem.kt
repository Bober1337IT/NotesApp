...
fun NoteItem(
    ...
    Box(
        ...
        Canvas(
            // matchParentSize makes the Canvas inherit its size from the parent Box
            ...
            // clipPath acts like a cookie cutter
            // it ensures that everything drawn inside this block stays within the boundaries of the defined shape
            clipPath(clipPath){
                drawRoundRect(
